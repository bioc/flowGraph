...
A note that input cell population phenotype names must be made up of
marker/measurement conditions <marker><-+> e.g. ssc+cd45- and the 
markers/measurements must not contain an underscore. Optionally, underscores
can be used to separate marker/measurement conditions e.g. ssc+_cd45-.
