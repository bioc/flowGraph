...
During the creation of this package, we used the deprecated `flowType` package 
to enumerate the cell counts for each cell population. While these cell counts 
can be easily enumerated manually, we note that `flowType`'s successor,
`flowTypeFilter` will be available soon on Bioconductor.
